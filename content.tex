...
Sequence to sequence models such as the Transformer have provided 

However the same is not true for mathematical reasoning. This type of reasoning, which involves a wide array of cognitive skills and generalization ability, is widely unexplored in the broader machine learning literature. 



\subsubsection{Related Work}

There have been a couple recent studies exploring mathematical reasoning. \supercite{Topalidou:2015}

In contrast to these studies, Saxton et al. (cite) carves out its niche by providing a novel dataset of mathematics tasks ranging from algebra, arithmetic, and probability to calculus and number theory.   
